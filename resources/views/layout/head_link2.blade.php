...
<aside class="aside is-placed-left is-expanded">
	...
	<div class="menu is-menu-main">
		...
		<ul class="menu-list">
			...
			@if(auth()->user()->walikelas == "walikelas")
			<li>
				<a href="{{ url('admin/naik_kelas') }}" class="has-icon">
					<span class="icon"><i class="mdi mdi-chevron-double-up"></i></span>
					<span class="menu-item-label">Naik kelas</span>
				</a>
			</li>
			<li>
			...
			<li>
				<a href="{{ url('admin/jadwal') }}" class="has-icon">
			...
			<li>
				<a href="{{ url('s/admin/naik_kelas') }}" class="has-icon">
					<span class="icon"><i class="mdi mdi-chevron-double-up"></i></span>
					<span class="menu-item-label">Naik kelas</span>
				</a>
			</li>
			<li>
				<a href="{{ url('s/admin/mapel') }}" class="has-icon">
					<span class="icon"><i class="mdi mdi-book-minus"></i></span>
					<span class="menu-item-label">Mapel</span>
				</a>
			</li>
			{{-- <li>
				<a href="{{ url('s/admin/semua_nilai') }}" class="has-icon">
					<span class="icon"><i class="mdi mdi-alphabetical"></i></span>
					<span class="menu-item-label">Semua nilai</span>
				</a>
			</li> --}}
			<li>
				<a class="has-icon has-dropdown-icon">
				...
				<ul>
					<li>
						<a href="{{ url('s/admin/jadwal/create') }}">
							<span>Tambah jadwal</span>
						</a>
					</li>
					<li>
						<a href="{{ url('s/admin/jadwal') }}">
...
{{-- @dd(session('sessionujian')); --}}
<section class="section">
	{{-- @dd(session('sessionujian')) --}}
	@if(session('sessionujian'))
	<div class="notification is-danger">
		Soal dari Ujian: <br>
		@foreach(session('sessionujian') as $kesalahan)
		<li>{{ $kesalahan->judul }}</li>
		@endforeach
		ada yang kosong lengkapi agar ujian bisa di aktifkan
	</div>
	@endif
	@yield('body_link')
</section>
